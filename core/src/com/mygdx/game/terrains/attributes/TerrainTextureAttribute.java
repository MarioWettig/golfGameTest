...
public class TerrainTextureAttribute extends TerrainAttribute {
	...
	protected static long Mask = DiffuseBase | DiffuseSlope | DiffuseHeight;
	 ...
	 * on the shader and {@link Attribute#type} value. For basic (model specific) types (e.g. {@link #}, {@link #},
	...
	@Override
	public TerrainAttribute copy () {return new TerrainTextureAttribute(this);
	}
